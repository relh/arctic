...
class SeqArcticDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        #seq_list = [self.getitem(imgname) for imgname in seq]
        #collated = default_collate(seq_list)
    ...
    def getitem(self, imgname, load_rgb=False):
        args = self.args
        # LOADING START
    ...
    def __init__(self, args, split, seq=None):
        ...
        #self.seqs = [] 
        #self.seqs = [[x for x in self.imgnames if seq in x] for seq in seqs]
